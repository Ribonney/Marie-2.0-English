...
__help__ = """
*Admin only:*
 - /del: yanıtlanılan mesajı siler
 - /purge: yanıtlanılan mesaj ile son mesaja kadar olan mesajları siler
 - /purge <integer X>: yanıtlanılan mesajdan sonra x adet mesaj siler.
"""
